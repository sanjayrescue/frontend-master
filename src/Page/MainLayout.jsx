  ...
  <div className="w-full px-5 mx-auto py-4 flex flex-col md:flex-row items-center justify-end">
    ...
    <div className="flex flex-wrap md:flex-nowrap items-center gap-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <p className="font-semibold">
          Email Us :
          <span className="text-gray-400">  support@Trustlinefintech</span>
        </p>
      </div>
    </div>
  </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-300">
            <li className="flex items-start gap-3">
              ...
              <a href="mailto:support@Trustlinefintech" className="hover:text-[#12B99C] transition">support@Trustlinefintech</a>
            </li>
            <li className="flex items-start gap-3">
